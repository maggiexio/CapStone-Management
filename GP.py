...
with col11:
  ...
  st.markdown ("Team 5")
  st.markdown("Data are collected from ALM 2022 Capstone class. There are 17 responses in total. Three survey questions are: 1) Where do you origianlly come from? 2)Do you have currencies other than US dollar? 3)If you do NOT have US curency, do you want it? Among 9 respondents who have currencies other than US dollar, 8 of them want US currency. ")
